...
My testing indicates you can set timeest=0, no sleep, if running outside the SAS Pyhton pipe
  ...
  PROGRAM FLOW
      ...
      8. After sleeping for n seconds the stattransfer subprocess is terminated.
         ...
         I looked at python muti processing but gave up because it seems very complex
         I don't think it is posiible to get a completion code from stattrasfer. Looked into spawning but failed to get it to work.
